...
`raw/site_location.json` records the station's USGS WGS84 coordinates. The location map transforms them to NAD83 / UTM zone 13N (EPSG:26913) for a local, meter-based locator display.
